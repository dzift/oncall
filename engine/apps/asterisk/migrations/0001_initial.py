    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_call_record', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='asterisk_asteriskphonecall_related', related_query_name='asterisk_asteriskphonecalls', to='phone_notifications.phonecallrecord')),
            ],
            options={
                'abstract': False,
            },
